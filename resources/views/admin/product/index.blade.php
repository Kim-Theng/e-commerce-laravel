          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                @if($row->status === 1)
                  <a href="{{ URL::to('inactive/product/'.$row->id) }}" class="btn btn-sm btn-info" title="active" ><i class="fa fa-thumbs-up"></i></a>
                @else
                  <a href="{{ URL::to('active/product/'.$row->id) }}" class="btn btn-sm btn-danger" title="inactive" ><i class="fa fa-thumbs-up"></i></a>
                @endif
              </td>
            </tr>
            @endforeach
