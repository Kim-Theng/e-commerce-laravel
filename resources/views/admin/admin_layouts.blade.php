...
<html lang="en">
  <head>
    ...
    <title>E-commerce Site Admin Panel</title>
  ...
  <body>
    ...
    @else
        ...
        <!-- ########## START: LEFT PANEL ########## -->
        <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> Kim-Ecommerce</a></div>
          <div class="sl-sideleft">
            ...
            <div class="sl-sideleft-menu">
              ...
              <ul class="sl-menu-sub nav flex-column">
                ...
                <li class="nav-item"><a href="{{ route('all.product') }}" class="nav-link">Add Post</a></li>
